...
const Hero = () => {
  ...
  const pauseBeforeDelete = 1000; // milliseconds (pause after full text typed)
  const pauseBeforeRetype = 3000; // milliseconds (pause after full text deleted - user request)
